    ...
    <>
          <div className="bg-[#0F172B]/50 p-6 rounded-2xl border border-[#2B7FFF]/20">
            ...
            <div className="space-y-6">
              ...
              {/* play button */}
              <div
                className="flex justify-center items-center p-3 gap-1 border border-[#AD46FF]/30 bg-gradient-to-r from-[#AD46FF]/30 via-[#AD46FF]/20 to-[#C27AFF]/20 rounded-xl"
              >
              ...
              <div>
                ...
                <div className="space-y-3 bg-[#1D293D] rounded-xl p-4">
                  <div className="space-y-1">
                    ...
                    <p className="text-white text-xs">Thank you for calling UBreakiFix! How can I help you today?</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-blue-500">Customer:</p>
                    <p className="text-white text-xs">Hi, my iPhone 13 screen is cracked. How much would it cost to repair?</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-green-500">AI Assistant:</p>
                    <p className="text-white text-xs">I can help you with that! For an iPhone 13 screen repair, our price is $199. This includes parts, labor, and comes with a 90-day warranty. Would you like to book an appointment?</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-blue-500">Customer:</p>
                    <p className="text-white text-xs">Yes, please! When are you available?</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-green-500">AI Assistant:</p>
                    <p className="text-white text-xs">Great! I have availability today at 2:00 PM or tomorrow at 10:00 AM. Which works better for you?</p>
                  </div>
                </div>
              </div>
            </div>
